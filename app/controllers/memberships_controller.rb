...
class MembershipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @membership.save
        format.html { redirect_to member_membership_path(id: @membership.id, member_id: @member.id), notice: t('.created') } # rubocop:disable Metrics/LineLength
  ...
  def update
    respond_to do |format|
      if @membership.update(membership_params)
        format.html { redirect_to member_membership_path(id: @membership.id, member_id: @member.id), notice: t('.updated') } # rubocop:disable Metrics/LineLength
  ...
  def destroy
    @membership.destroy
    respond_to do |format|
      format.html { redirect_to @member, notice: t('.destroyed') }

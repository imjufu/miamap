...
module AdminRoom
  class ProducersController < AdminRoomController
    ...
    def create
      ...
      respond_to do |format|
        if @producer.save
          format.html { redirect_to admin_room_producer_path(@producer), notice: t('.created') }
    ...
    def update
      respond_to do |format|
        if @producer.update(producer_params)
          format.html { redirect_to admin_room_producer_path(@producer), notice: t('.updated') }
    ...
    def destroy
      @producer.destroy
      respond_to do |format|
        format.html { redirect_to admin_room_producers_url, notice: t('.destroyed') }

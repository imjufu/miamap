...
RSpec.describe 'Memberships', type: :request do
  ...
  within_subdomain 'guillamap' do
    describe 'GET /members/1/memberships/1' do
      let(:action) { get "/members/#{member.id}/memberships/#{membership.id}" }
    ...
    describe 'GET /members/1/memberships/new' do
      let(:action) { get "/members/#{member.id}/memberships/new" }
    ...
    describe 'POST /members/1/memberships' do
      let(:params) do
      ...
      let(:action) do
        post "/members/#{member.id}/memberships", params: { membership: params }
      end
      ...
      context 'when the user is logged in as an admin' do
        ...
        context 'with invalid params' do
          it 'displays an error' do
            post "/members/#{member.id}/memberships", params: {
    ...
    describe 'GET /members/1/memberships/1/edit' do
      let(:action) do
        get "/members/#{member.id}/memberships/#{membership.id}/edit"
      end
    ...
    describe 'DELETE /members/1/memberships/1' do
      let(:action) do
        delete "/members/#{member.id}/memberships/#{membership.id}"
      end

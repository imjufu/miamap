...
module AdminRoom
  class MembershipFormsController < AdminRoomController
    ...
    def create
      ...
      respond_to do |format|
        if @membership_form.save
          format.html { redirect_to admin_room_membership_form_path(@membership_form), notice: t('.created') }
    ...
    def update
      respond_to do |format|
        if @membership_form.update(membership_form_params)
          format.html { redirect_to admin_room_membership_form_path(@membership_form), notice: t('.updated') }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_room_membership_forms_url, notice: t('.destroyed') }

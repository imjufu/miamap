...
class PaymentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment.save
        format.html { redirect_to subscription_payment_path(id: @payment.id, subscription_id: @subscription.id), notice: t('.created') } # rubocop:disable Metrics/LineLength
  ...
  def update
    respond_to do |format|
      if @payment.update(payment_params)
        format.html { redirect_to subscription_payment_path(id: @payment.id, subscription_id: @subscription.id), notice: t('.updated') } # rubocop:disable Metrics/LineLength
  ...
  def destroy
    @payment.destroy
    respond_to do |format|
      format.html { redirect_to @subscription, notice: t('.destroyed') } # rubocop:disable Metrics/LineLength

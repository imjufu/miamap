...
Devise.setup do |config|
  ...
  config.mailer_sender = 'bonjour@miamap.fr'
  ...
  # unconfirmed_email db field (see migrations). Until confirmed,
  # new email is stored in unconfirmed_email column, and copied to email column
  ...
  # change the failure app, you can configure them inside the config.
  # warden block.
  #

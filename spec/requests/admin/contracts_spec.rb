...
RSpec.describe 'Admin/Contracts', type: :request do
  ...
  within_subdomain 'guillamap' do
    describe 'GET /admin/producers/1/contracts/1' do
      let(:action) { get "/admin/producers/#{producer.id}/contracts/#{contract.id}" }
    ...
    describe 'GET /admin/producers/1/contracts/new' do
      let(:action) { get "/admin/producers/#{producer.id}/contracts/new" }
    ...
    describe 'POST /admin/producers/1/contracts' do
      let(:params) { FactoryBot.attributes_for(:contract) }
      let(:action) do
        post "/admin/producers/#{producer.id}/contracts", params: { contract: params }
      end
      ...
      context 'when the user is logged in as an admin' do
        ...
        context 'with invalid params' do
          it 'displays an error' do
            post "/admin/producers/#{producer.id}/contracts", params: {
              contract: { title: '' }
            }
    ...
    describe 'GET /admin/producers/1/contracts/1/edit' do
      let(:action) do
        get "/admin/producers/#{producer.id}/contracts/#{contract.id}/edit"
      end
    ...
    describe 'PUT/PATCH /admin/producers/1/contracts/1' do
      let(:params) { { id: contract.id, title: 'Été 2019' } }
      let(:action) do
        put "/admin/producers/#{producer.id}/contracts/#{contract.id}", params: {
          contract: params
        }
      end
    ...
    describe 'DELETE /admin/producers/1/contracts/1' do
      let(:action) do
        delete "/admin/producers/#{producer.id}/contracts/#{contract.id}"
      end

...
RSpec.describe 'Admin/Members', type: :request do
  ...
  within_subdomain 'guillamap' do
    ...
    describe 'GET /admin/members/1' do
      let(:action) { get "/admin/members/#{member.id}" }
    ...
    describe 'GET /admin/members/new' do
      let(:action) { get '/admin/members/new' }
    ...
    describe 'POST /admin/members' do
      ...
      let(:action) { post '/admin/members', params: { member: params } }
      ...
      context 'when the user is logged in as an admin' do
        ...
        context 'with invalid params' do
          it 'displays an error' do
            post '/admin/members', params: { member: { first_name: '' } }
    ...
    describe 'GET /admin/members/1/edit' do
      let(:action) { get "/admin/members/#{member.id}/edit" }
    ...
    describe 'PUT/PATCH /admin/members/1' do
      let(:params) { { id: member.id, first_name: 'John' } }
      let(:action) { put "/admin/members/#{member.id}", params: { member: params } }
    ...
    describe 'DELETE /admin/members/1' do
      let(:action) { delete "/admin/members/#{member.id}" }

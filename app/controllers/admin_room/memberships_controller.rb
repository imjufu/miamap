  ...
  class MembershipsController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @membership.save
          format.html { redirect_to admin_room_member_membership_path(id: @membership.id, member_id: @member.id), notice: t('.created') }
    ...
    def destroy
      @membership.destroy
      respond_to do |format|
        format.html { redirect_to admin_room_member_path(@member), notice: t('.destroyed') }

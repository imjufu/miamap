...
module Admin
  class SubscriptionsController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @subscription.save
          format.html { redirect_to admin_subscription_path(@subscription), notice: t('.created') }
    ...
    def update
      respond_to do |format|
        if @subscription.update(subscription_params)
          format.html { redirect_to admin_subscription_path(@subscription), notice: t('.updated') }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_subscriptions_url, notice: t('.destroyed') }
